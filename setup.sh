...
if [ "" = "$PKG_OK" ]; then
  ...
  echo -e "[ ${BBlue}NOTES${NC} ] enter now to install script by Lynz Store"
  read
else
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/LynzVPN/foryou/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/LynzVPN/foryou/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/LynzVPN/foryou/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/LynzVPN/foryou/main/menu/versi  )
...
echo "---------------------------LynzAja-----------------------------" | tee -a log-install.txt
echo "==================================================================" | tee -a log-install.txt
echo -e ""
echo ""
echo "" | tee -a log-install.txt
